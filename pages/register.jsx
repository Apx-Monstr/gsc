            ...
            <div className=" max-w-screen-xl mx-auto h-screen px-16 flex justify-start items-center">
                <div className="bg-white border rounded-lg w-full max-w-lg p-4 px-8">
                    ...
                    <div className="flex text-base">
                        <div className="border-b-2 border-black rounded-none flex-1  p-4 py-2.5 text-center text-lg cursor-pointer">
                            NGO
                        </div>
                        <div className="border-b-2 border-gray-300 text-gray-300 rounded-none flex-1  p-4 py-2.5 text-center text-lg cursor-pointer">
                            User
                        </div>
                    </div>
